  ...
  return (
    <div>
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='flex items-center justify-around pb-10 my-10 px-4 md:mx-0'>
            {
                popularUser?.slice(0,3)?.map((user,index)=>{
                    return <div key={index} className='flex flex-col gap-2 items-center'>
                        <img src={user.photoUrl || userLogo} alt="" className='rounded-full w-16 h-16 md:w-32 md:h-32'/>
