...
const BlogCardList = ({ blog }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-700 dark:border-gray-700 flex flex-col md:flex-row md:gap-10 p-5 rounded-2xl mt-6 shadow-lg border transition-all">
      <div>
        <img
          src={blog.thumbnail}
          alt=""
      ...
      <div>
        ...
        <Button
          ...
          className="mt-4 px-4 rounded-lg text-sm"
        >
          Read More
        </Button>
      </div>
